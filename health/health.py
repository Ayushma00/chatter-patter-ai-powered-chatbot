...
model = load_model(os.path.join(BASE_DIR,'health_model.h5'))
purpose = json.loads(open(os.path.join(BASE_DIR,'health.json')).read())
tags = pickle.load(open(os.path.join(BASE_DIR,'health_tags.pkl'), 'rb'))
words = pickle.load(open(os.path.join(BASE_DIR,'health_words.pkl'), 'rb'))
