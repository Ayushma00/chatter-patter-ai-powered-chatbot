...
model = load_model(os.path.join(BASE_DIR,'agriculture_model.h5'))
purpose = json.loads(open(os.path.join(BASE_DIR,'agriculture.json')).read())
tags = pickle.load(open(os.path.join(BASE_DIR,'agriculture_tags.pkl'), 'rb'))
words = pickle.load(open(os.path.join(BASE_DIR,'agriculture_words.pkl'), 'rb'))
