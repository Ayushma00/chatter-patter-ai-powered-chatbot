...
model = load_model(os.path.join(BASE_DIR,'culture_model.h5'))
purpose = json.loads(open(os.path.join(BASE_DIR,'culture.json')).read())
tags = pickle.load(open(os.path.join(BASE_DIR,'culture_tags.pkl'), 'rb'))
words = pickle.load(open(os.path.join(BASE_DIR,'culture_words.pkl'), 'rb'))
