...
model = load_model(os.path.join(BASE_DIR,'politics_model.h5'))
purpose = json.loads(open(os.path.join(BASE_DIR,'politics.json')).read())
tags = pickle.load(open(os.path.join(BASE_DIR,'politics_tags.pkl'), 'rb'))
words = pickle.load(open(os.path.join(BASE_DIR,'politics_words.pkl'), 'rb'))
